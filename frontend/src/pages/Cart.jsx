    ...
    <div className="flex flex-col md:flex-row mt-16">
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-medium mb-6">
          Shopping Cart <span className="text-sm text-[#4fbf8b]
">{getCartCount()}</span>
        </h1>
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
              ...
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
               ...
               {address.street}, {address.city}, {address.state}, {address.country}
                ...
                <p
                  ...
                  className="text-[#4fbf8b] text-center cursor-pointer p-2 hover:bg-[#44ae7c]"
                >
                  Add address
                </p>
              </div>
          ...
          <select onChange={(e) => setPaymentOptions(e.target.value)} className="w-full border border-gray-300 bg-white px-3 py-2 mt-2 outline-none">
